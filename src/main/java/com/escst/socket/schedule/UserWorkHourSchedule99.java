...
import com.escst.socket.dao.localSqlServer99.hongmo.userWork.UserWorkHourDao99;
 ...
 */
public class UserWorkHourSchedule99 {
...
//                double noontimeRest = Double.parseDouble(noontimeRestStr);
    ...
    @Inject
    private DeviceTaskDao99 deviceTaskDao;
    @Inject
    private UserWorkHourDao99 userWorkHourDao;
}
