 ...
 *
 */
public class RegisterUserService99 {
	Logger logger = LoggerFactory.getLogger(RegisterUserService99.class);

	private RegisterUserInfoDao99 registerUserInfoDao;

	public RegisterUserService99(RegisterUserInfoDao99 registerUserInfoDao){
